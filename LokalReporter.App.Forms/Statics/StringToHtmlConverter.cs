...
namespace LokalReporter.App.FormsApp.Statics
{
    ...
    public class StringToHtmlConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            <link rel='stylesheet' id='idvl-editor-css'  href='http://lokalreporter.idvl.de/wp-content/themes/lokalreporter/idvl-editor/css/idvl-editor.css?ver=1.0.3' type='text/css' media='all' />
        </head>
<body>{s}</body></html>";
        }
